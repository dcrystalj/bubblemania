...
public class GL_Triangle
{
        ...
        public ArrayList<GL_Triangle> neighborsP1 = new ArrayList<GL_Triangle>(); // Neighbor triangles of vertex1
        public ArrayList<GL_Triangle> neighborsP2 = new ArrayList<GL_Triangle>(); // Neighbor triangles of vertex2
        public ArrayList<GL_Triangle> neighborsP3 = new ArrayList<GL_Triangle>(); // Neighbor triangles of vertex3
		 ...
		 */
		public GL_Vector recalcVertexNormal(ArrayList<GL_Triangle> neighbors)
        {
            float nx = 0;
            float ny = 0;
            float nz = 0;
        ...
        public GL_Triangle makeClone()
        {
            ...
            clone.neighborsP1 = (ArrayList<GL_Triangle>)neighborsP1.clone();
            clone.neighborsP2 = (ArrayList<GL_Triangle>)neighborsP2.clone();
            clone.neighborsP3 = (ArrayList<GL_Triangle>)neighborsP3.clone();
            return clone;
        }
}