...
public class GL_OBJ_Importer {
    ...
    public GL_Mesh makeMeshObject(GL_OBJ_Reader objData) {
        ArrayList<float[]> verts = objData.vertices;
        ArrayList<float[]> txtrs = objData.textureCoords;
        ArrayList<float[]> norms = objData.normals;
        ArrayList<Face> faces = objData.faces;
